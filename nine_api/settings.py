"""
Django settings for nine_api project.
...
ALLOWED_HOSTS = [
    "localhost",
    "192.168.88.31", "192.168.88.33", "192.168.88.34", "192.168.0.100",
...
WSGI_APPLICATION = 'nine_api.wsgi.application'
...
ASGI_APPLICATION = "nine_api.asgi.application"
...
CORS_ORIGIN_WHITELIST = ["https://nineapp.vercel.app", "https://nine-ui.vercel.app", "https://*.railway.app", "http://localhost:3000"]
CORS_ALLOW_ALL_ORIGIN = True
CSRF_TRUSTED_ORIGINS = ["https://*.vercel.app", "https://*.netlify.app", "https://*.railway.app"]
    ...
    "default": {
        ...
        "OPTIONS": {
            ...
            "CONNECTION_POOL_KWARGS": {
                "max_connections": 100, "retry_on_timeout": True, "ssl_cert_reqs": None
            }
        }
    }
}
...
# ]
DEFAULT_FILE_STORAGE = "nine_api.storage_backends.MediaStorage"     # The media storage configuration
